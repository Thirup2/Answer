...
** 返回值：链表指针
*/
SLL_API PtrLL DLL_CALL InitList(void);
...
** 参数：链表指针
*/
SLL_API void DLL_CALL DestroyList(PtrLL list);
...
** 3. 否则执行操作返回SUCCESS
*/
SLL_API Status DLL_CALL GetElem(cPtrLL list, size_t position, PtrElem elem);
...
** 2. 否则返回0
*/
SLL_API size_t DLL_CALL LocateElem(cPtrLL list, cPtrElem elem);
...
** 2. 否则执行操作返回SUCCESS
*/
SLL_API Status DLL_CALL ListInsert(PtrLL list, size_t position, cPtrElem elem);
...
** 3. 否则执行操作返回SUCCESS
*/
SLL_API Status DLL_CALL ListDelete(PtrLL list, size_t position, PtrElem elem);
...
** 返回值：链表表长
*/
SLL_API size_t DLL_CALL ListLength(cPtrLL list);
